In order to view, simply download the index.html, script.js, and styles.css - then simply open the index.html file (preferably with Chrome) to view the calculator.
